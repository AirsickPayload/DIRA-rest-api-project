 ...
 */
    ...
    public class StudentClassAssignmentException extends WebApplicationException {
        public StudentClassAssignmentException(String message, String userMessage, String info) {
